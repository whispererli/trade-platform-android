	...
	private void refreshUpdatedAtValue() {
		...
		if (lastUpdateTime == -1) {
			...
			String value = timeIntoFormat
					+ this.getContext().getString(R.string.minite);
			updateAtValue = String.format(
					getResources().getString(R.string.updated_at), value);
		} else if (timePassed < ONE_DAY) {
			timeIntoFormat = timePassed / ONE_HOUR;
			String value = timeIntoFormat
					+ this.getContext().getString(R.string.hour);
			updateAtValue = String.format(
					getResources().getString(R.string.updated_at), value);
		} else if (timePassed < ONE_MONTH) {
			timeIntoFormat = timePassed / ONE_DAY;
			String value = timeIntoFormat
					+ this.getContext().getString(R.string.day);
			updateAtValue = String.format(
					getResources().getString(R.string.updated_at), value);
		} else if (timePassed < ONE_YEAR) {
			timeIntoFormat = timePassed / ONE_MONTH;
			String value = timeIntoFormat
					+ this.getContext().getString(R.string.month);
			updateAtValue = String.format(
					getResources().getString(R.string.updated_at), value);
		} else {
			timeIntoFormat = timePassed / ONE_YEAR;
			String value = timeIntoFormat
					+ this.getContext().getString(R.string.year);
			updateAtValue = String.format(
					getResources().getString(R.string.updated_at), value);
		}
